      ...
      <Container className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          <Paragraph variant="lead">
            Não vejo meu papel apenas como o criador de telas elegantes. Minha responsabilidade é{" "}
            <span className="font-semibold text-zinc-900 dark:text-zinc-100 group-hover:text-cyan-600 dark:group-hover:text-[#00ffff] transition-colors duration-300">
              alinhar a visão comercial à engenharia
            </span>
            , garantindo que o produto resolva problemas reais sem acumular débito técnico.
          </Paragraph>

          <Paragraph variant="base">
            Ao longo de anos trabalhando em produtos complexos, percebi que a falta de maturidade em UX não decorre da falta de talento individual, mas de{" "}
            <span className="font-semibold text-zinc-900 dark:text-zinc-100 group-hover:text-cyan-600 dark:group-hover:text-[#00ffff] transition-colors duration-300">
              falhas de comunicação organizacional
            </span>
            . Quando designers não entendem de negócios e desenvolvedores são excluídos da concepção, o produto sofre.
          </Paragraph>

          <Paragraph variant="base">
            Minha atuação consiste em{" "}
            <span className="font-semibold text-zinc-900 dark:text-zinc-100 group-hover:text-cyan-600 dark:group-hover:text-[#00ffff] transition-colors duration-300">
              construir essa ponte de comunicação
            </span>
          ...
          <Paragraph variant="base" className="font-serif italic border-l-2 border-zinc-300 dark:border-zinc-800 pl-4 py-1 text-zinc-700 dark:text-zinc-300">
            ...
            <span className="font-semibold text-zinc-800 dark:text-zinc-200 group-hover:text-cyan-600 dark:group-hover:text-[#00ffff] transition-colors duration-300">
              valor prático que ele gera aos usuários
            </span>{" "}
            e pela facilidade com que o código pode se adaptar às mudanças de mercado.&rdquo;
          </Paragraph>
        </div>
      </Container>
    </section>
